...
const CACHE = "pr-expenses-v12";
const CORE  = ["./","./index.html","./styles.v12.css","./app.v12.js","./manifest.json","./icons/icon-192.png","./icons/icon-512.png"];
...
self.addEventListener("fetch", e => {
  ...
  const isApp  = url.pathname.endsWith("/app.v12.js");
  if (isHTML || isApp) {
